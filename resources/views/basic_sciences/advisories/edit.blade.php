    ...
    <form action="{{ route('basic_sciences.advisories.update', $advisory->advisory_id) }}"
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="time" name="end_time"value="{{ \Carbon\Carbon::createFromFormat('H:i:s', $advisory->end_time)->format('H:i') }}"
                class="w-full border rounded-lg p-3 focus:ring-2 focus:ring-blue-500" required>
            </div>
        ...
        <div class="mt-8">
            ...
            <ul class="list-disc ml-6 text-gray-700 bg-gray-50 border rounded-lg p-4">
        ...
        <div class="mt-6">
            ...
            <input type="file" name="assignment_file" class="w-full border p-3 rounded-lg bg-white">
        </div>

        {{-- BOTONES --}}
        <div class="mt-8 flex justify-between">
            <a href="{{ route('basic_sciences.advisories.index') }}"
               class="px-5 py-3 bg-gray-600 text-white rounded-lg hover:bg-gray-700">
                ← Cancelar
            </a>

            <button class="px-6 py-3 bg-green-600 text-white font-bold rounded-lg hover:bg-green-700 shadow">
                Guardar cambios
            </button>
        </div>
