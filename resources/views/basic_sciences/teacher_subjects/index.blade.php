...
<body class="bg-gray-100 min-h-screen flex flex-col">
    ...
    <div class="max-w-6xl mx-auto bg-white shadow-xl rounded-xl p-8 mt-10">
        ...
        {{-- TÍTULO --}}
        <h1 class="text-3xl font-bold mb-8 text-[#0B3D7E] flex items-center gap-2">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div>
                    ...
                    <input type="text" name="search_teacher"
                           ...
                           class="w-full p-2 border rounded-lg focus:ring-2 focus:ring-blue-300 focus:outline-none">
                </div>
                    ...
                    <tr class="border-b hover:bg-gray-100 transition">
                        ...
                        <td class="px-4 py-3 text-center flex justify-center gap-3">
                            ...
                            <a href="{{ route('basic_sciences.teacher_subjects.edit', $ts->teacher_subject_id) }}"
                               class="px-3 py-1 text-white font-semibold rounded shadow hover:opacity-90"
